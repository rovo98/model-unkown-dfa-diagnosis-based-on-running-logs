# Define  model using  LSTM (Long short term memory) layers only
# author rovo98
...
def run_experiment(repeats=10):
    ...
    #     score = evaluate_lstm_model(train_x, train_y, test_x, test_y, num_of_faulty_type, lstm_output_size)
    #     score = score * 100.0
