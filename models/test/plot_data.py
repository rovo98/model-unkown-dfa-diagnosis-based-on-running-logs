...
class MyTestCase(unittest.TestCase):
    ...
    def test_plotting_accuracies(self):
        ...
        ax.scatter(dataset, fdconv1dlstm, label='fdConv1dLSTM', marker='8')
    ...
    def test_plotting_exper_data(self):
        ...
        # ax.scatter(log_size_range, ls_fctree, label='FCCtT')
        ...
        # ax.scatter(log_size_range, ls_fdconv1dlstm, label='fdConv1dLSTM', marker='8')
        ...
        ax.scatter(log_length_range, ll_fctree, label='FCCtT')
        ...
        ax.scatter(log_length_range, ll_fdconv1dlstm, label='fdConv1dLSTM', marker='8')
