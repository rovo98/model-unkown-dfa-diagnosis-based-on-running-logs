...
def build_fdconv1d_multichannel(input_shape, n_outputs, lr=1e-3):
    ...
    # FIXME: temporary using small kernel_size for short representation.
    conv1 = Conv1D(filters=64, kernel_size=21, activation='relu')(inputs1)
    conv1_2 = Conv1D(filters=128, kernel_size=21, activation='relu')(conv1)
    conv1_3 = Conv1D(filters=64, kernel_size=21, activation='relu')(conv1_2)
    ...
    conv2 = Conv1D(filters=64, kernel_size=25, activation='relu')(inputs2)
    conv2_2 = Conv1D(filters=128, kernel_size=25, activation='relu')(conv2)
    conv2_3 = Conv1D(filters=64, kernel_size=25, activation='relu')(conv2_2)
    ...
    conv3 = Conv1D(filters=64, kernel_size=31, activation='relu')(inputs3)
    conv3_2 = Conv1D(filters=128, kernel_size=31, activation='relu')(conv3)
    conv3_3 = Conv1D(filters=64, kernel_size=31, activation='relu')(conv3_2)
